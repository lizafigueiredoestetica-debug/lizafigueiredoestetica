        ...
        ${ag.sessoes.map((s,i) => {
          ...
          <div class="agenda-sessao-row ${cls}">
            ...
            <div class="agenda-sessao-status" style="display:flex;gap:0.5rem;align-items:center;flex-wrap:wrap">
              ...
              ${(s.status !== 'realizado' && s.status !== 'falta') ? `<button onclick="event.stopPropagation();abrirModalFalta('${ag.id}',${i})" style="background:#FFF0F0;border:1px solid #FFCDD2;color:#C62828;border-radius:8px;padding:4px 8px;font-size:11px;cursor:pointer" title="Marcar falta">❌ Falta</button>` : ''}
